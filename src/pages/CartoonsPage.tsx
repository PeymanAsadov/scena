...
export default function CartoonsPage() {
    ...
    const genres = ['All', 'Action', 'Adventure', 'Sci-Fi', 'Animation', 'Comedy'];
    ...
    const filteredCartoons = myCustomCartoons
        .filter((cartoon) => selectedGenre === 'All' || cartoon.genres?.includes(selectedGenre))
        .sort((a, b) => {
            if (sortBy === 'rating') {
        ...
        <div className="min-h-screen bg-[#0d0d11] text-white pt-24 px-6 md:px-16 pb-16">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mt-1">CARTOONS</h1>
                    <p className="text-zinc-400 text-sm mt-1">
                        Explore all animated movies and cartoons with genre pickers, release sorting, and top ratings.
                    </p>
                </div>

...
export default function SeriesPage() {
    ...
    const filteredSeries = myCustomSeries
        .filter((series) => selectedGenre === 'All' || series.genres?.includes(selectedGenre))
        .sort((a, b) => {
            if (sortBy === 'rating') {
        ...
        <div className="min-h-screen bg-[#0d0d11] text-white pt-24 px-6 md:px-16 pb-16">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white mt-1">TV SERIES</h1>
                    <p className="text-zinc-400 text-sm mt-1">
                        Explore all TV shows with genre pickers, season filters, and top ratings.
                    </p>
                </div>
